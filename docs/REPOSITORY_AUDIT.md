...
| API operations | Preserved sanitized responses while mapping provider throttling to bounded `429` retry guidance and provider authentication or outage responses to `503`. | `api/src/create-app.ts`, `api/test/app.test.ts` |
