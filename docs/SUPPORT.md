...
- Arduino Nano 33 IoT running Voxa Cue firmware 1.2; Nano ESP32 remains supported
...
1. Confirm the Nano is powered and the serial monitor printed `Voxa Cue firmware 1.2 ready`.
